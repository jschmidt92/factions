class CfgVehicles {
    ...
    class CLASS(I_TeamLeader_01_F): I_Soldier_F {
        ...
        class Eventhandlers: Eventhandlers {
            init = "[(_this select 0), ""default""] call factions_mercs_fnc_setUnitLoadout; [(_this select 0), nil, nil] call BIS_fnc_unitHeadgear;";
        };
    };
    ...
    class CLASS(I_Rifleman_02_F): CLASS(I_TeamLeader_01_F) {
        ...
        respawnWeapons[] = {"CUP_arifle_G3A3_ris_vfg", "CUP_hgun_Glock17_blk", "Throw", "Put"};
    ...
    class CLASS(I_Combat_Life_Saver_01_F): CLASS(I_TeamLeader_01_F) {
        ...
        respawnWeapons[] = {"CUP_arifle_L85A2_G", "CUP_hgun_Glock17_blk", "Throw", "Put"};
    ...
    class CLASS(I_Marksman_01_F): CLASS(I_TeamLeader_01_F) {
        ...
        respawnWeapons[] = {"CUP_srifle_M107_Base", "CUP_hgun_Glock17_blk", "Throw", "Put"};
        magazines[] = {};
        respawnMagazines[] = {};
        ...
        class Eventhandlers: Eventhandlers {
            init = "[(_this select 0), ""marksman""] call factions_mercs_fnc_setUnitLoadout; [(_this select 0), nil, nil] call BIS_fnc_unitHeadgear;";
        };
    };
};